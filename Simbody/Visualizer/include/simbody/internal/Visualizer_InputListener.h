...
to get through the simbody-visualizer.
...
@code
std::cout << "Hit ENTER in simbody-visualizer to continue ...\n";
...
simbody-visualizer.\ Any kind of input will terminate the wait; you'll have
